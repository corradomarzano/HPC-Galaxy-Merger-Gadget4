...
path_in = r"D:\Backup Drive Università\Computing Methods for Astrophysics\Dati\output_final" # Insert the path to the directory where your .hdf5 snapshot files, your simulation results' data, are stored
path_out = r"D:\Backup Drive Università\Computing Methods for Astrophysics\Gadget4 files\prova" # Insert the path to the directory where you want to save your data in .csv format
